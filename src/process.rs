...
use crate::{device::{self, Device, KernelDevice, UserDevice}, event::Event, link::LinkTable, request, tag::TagVec, user::user_task};
...
pub struct Process {
    ...
    pub workspace: RwMutex<LinkTable>,
}
impl Process {
    ...
    pub fn device_new(&self) -> u64 {
        self.devices.write().push(UserDevice::new())
    }
